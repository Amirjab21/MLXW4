...
learning_rate = 1e-4
optimizer = torch.optim.Adam(model.parameters(), learning_rate) # different to original
epochs = 10
criterion = nn.CrossEntropyLoss() #different - ignore_index
...
print(train_dataset, train_dataset[0], "clock")
...
#             output = model.forward(image, captionwithoutend)
